...
public class DBRepository : IRepository
{
    ...
    public List<WorkoutSession> GetAllWorkouts()
    {
        ...
        SqlCommand cmd = new SqlCommand("SELECT * FROM WorkoutSessions; SELECT * FROM Exercises;", connection);
        ...
        while(reader.Read()) {
            allWorkouts.Add(new WorkoutSession {
                ...
                WorkoutExercises = (List<Exercise>) reader["ExersiceName","ExerciseNote"]});
        }
